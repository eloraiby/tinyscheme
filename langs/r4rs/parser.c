...
#include <stdio.h>
#include <assert.h>
#line 9 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.yl"

#include <stdio.h>
#include "../../src/scheme-private.h"
#line 13 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.c"
...
#endif
#define parserARG_SDECL  scheme_t* sc ;
#define parserARG_PDECL , scheme_t* sc 
#define parserARG_FETCH  scheme_t* sc  = yypParser->sc 
#define parserARG_STORE yypParser->sc  = sc 
#define YYNSTATE 22
#define YYNRULE 17
...
static void yy_reduce(
  ...
  */
      case 0: /* program ::= cell */
#line 21 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.yl"
{ sc->op = yymsp[0].minor.yy34; }
#line 694 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.c"
        break;
...
#line 24 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.yl"
{ yygotominor.yy34 = yymsp[0].minor.yy0; }
#line 704 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.c"
        break;
      case 12: /* cell ::= QUOTE LPAR RPAR */
#line 39 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.yl"
{ yygotominor.yy34 = cell_new_cons(NULL); }
#line 709 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.c"
        break;
      case 13: /* cell ::= QUOTE cell */
      case 15: /* cell_list ::= cell */ yytestcase(yyruleno==15);
#line 40 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.yl"
{ yygotominor.yy34 = cell_new_cons(yymsp[0].minor.yy34); }
#line 715 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.c"
        break;
      case 14: /* cell ::= LPAR cell_list RPAR */
#line 41 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.yl"
{ yygotominor.yy34 = yymsp[-1].minor.yy34; }
#line 720 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.c"
        break;
      case 16: /* cell_list ::= cell_list cell */
#line 44 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.yl"
{ yygotominor.yy34 = cell_cons(yymsp[0].minor.yy34, yymsp[-1].minor.yy34); }
#line 725 "/home/kin/Projects/tinyscheme141/langs/r4rs/parser.c"
        break;
      default:
